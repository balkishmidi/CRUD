...
public class Conducteur {
    ...
    public String toString() {
        return "Conducteur{" + "id_conducteur=" + id_conducteur + ", cin_conducteur=" + cin_conducteur + ", nom_conducteur=" + nom_conducteur + ", prenom_conducteur=" + prenom_conducteur + ", ville_conducteur=" + ville_conducteur + ", telephone_conducteur=" + telephone_conducteur + ", email_conducteur=" + email_conducteur + ", mdp_conducteur=" + mdp_conducteur + ", type_de_permis=" + type_de_permis + ", image_conducteur=" + image_conducteur + '}';
    }
